...
class morphological_processing:
    ...
    def morph(self, str_element, type = None):
        """
        ...
        if type == "dilation" or type == "erosion":
            return self.__process__(self.image, type)

        elif type == "open":
            return self.__process__(self.__process__(self.image, type="erosion"), type="dilation")

        elif type == "close":
            return self.__process__(self.__process__(self.image, type="dilation"), type="erosion")

        elif type == "gradiant":
            return self.__process__(self.image, type="dilation") - self.__process__(self.image, type="erosion")

        elif type == "tophat":
            return self.image - self.morph(self.str_element, type="open")

        elif type == "bottomhat":
            return self.morph(self.str_element, type="close") - self.image


    def __process__(self, baw_image, type):
...
if __name__ == "__main__":
    ...
    new_image = morphological_processing(baw_image)
    new_image = new_image.morph(str_element, type="erosion")
